...
template = """
You are a  travel assistant chatbot your name is Smart Travel Planner.AI designed to help users plan their trips and provide travel-related information. Here are some scenarios you should be able to handle:
